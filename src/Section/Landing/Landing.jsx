...
//components
import LandingStatus from "../../Components/LandingStatus/LandingStatus"
            ...
            <section className="landing">
                ...
                <div className="container">
                        ...
                        <Typewriter
                            onInit={typeWriter => {
                                typeWriter
                                    ...
                                    .pauseFor(2000)
                                    .deleteAll()
                                    .typeString('بزن بریم برای ارتقای مهارتمون')
                                    .start()
                                    .pauseFor(2000)
                            }}
                            options={{
                    ...
                    <h2 className="landing__title">
                        <p style={{ display: 'inline' }}>با آکادمی سبزلرن برنامه نویسی رو با خیال راحت یاد بگیر   </p>
                        <Typewriter
                            onInit={typeWriter => {
                                typeWriter
                                    .pauseFor(5000)
                                    .typeString(' و پیشرفت کن ')
                                    .start()
                                    .pauseFor(2000)
                                    .deleteChars(13)
                                    .typeString(' و آماده شو برای بازار کار ')
                            }}
                            options={{
                                cursor: '< / >'
                            }}
                    ...
                    <div className="landing-parent">
                        ...
                        } statusText={'کاربر توی سبزلرن داریم'} />
                    </div>
