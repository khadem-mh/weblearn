...
export default function AdminPanelContacts() {
    ...
    const getCotacts = () => {
        fetch(`https://kind-tips-jam.loca.lt/v1/contact`)
            .then(res => res.json())
            .then(datas => {
                console.log(datas);
                setContact(datas)
    ...
    const sendResponse = event => {
        ...
        if (textInputRes.length) {
            ...
            fetch(`https://kind-tips-jam.loca.lt/v1/contact/answer`, {
                method: 'POST',
                headers: {
    ...
    const removeContactHandler = event => {
        event.preventDefault()
        if (choosIDForRemove) {
            fetch(`https://kind-tips-jam.loca.lt/v1/contact/${choosIDForRemove}`, {
                method: 'DELETE',
