...
export default function AdminPanelComments() {
  ...
  const AcceptComment = event => {
    ...
    fetch(`https://kind-tips-jam.loca.lt/v1/comments/accept/${getID}`, {
      method: 'PUT',
      headers: {
  ...
  const RejecctComment = event => {
    event.preventDefault()
    fetch(`https://kind-tips-jam.loca.lt/v1/comments/reject/${getID}`, {
      method: 'PUT',
      headers: {
        'Authorization': `Bearer ${JSON.parse(localStorage.getItem('user')).token}`,
      }
  ...
  const replyComment = (e) => {
    e.preventDefault()
    fetch(`https://kind-tips-jam.loca.lt/v1/comments/answer/${getID}`, {
      method: 'POST',
      headers: {
  ...
  const deleteComment = e => {
    ...
    fetch(`https://kind-tips-jam.loca.lt/v1/comments/${getID}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${JSON.parse(localStorage.getItem('user')).token}`,
      }
